...
\hline
& Value & Time & ($f$, Value) & Time & Value & Time & Value & Time\\
\hline
...
\hline 
\end{tabular}
\caption{Reported costs and running time for the set cover implementations. The $f$ in the simple rounding column denotes the choice of $f$ resulting in the feasible solution. The randomized rounding results denote the means of objective values for 10 feasible solutions' objective values.
\label{times}}
\end{table}
